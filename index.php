...
header("Access-Control-Allow-Origin: *"); // This allows all origins, to only allow requests from a specific
// domain remove this line and change the commented line below.
